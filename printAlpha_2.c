 ...
 * @ap: va list to  initialise a char pointer s
 * @f: point to flags struct
...
/**
 * printRot13 - print a string rot13 encryption
...
/**
 * checkPrintChar - check for printchar
 * @c : checked char
...
/**
 * convertHexTwoChar - Convert a char into hex into pointer s2
 * @nb: the number;
 * @s2: returned char pointer*;
...
/**
 * printS - print a string and replace no printable char to \x
 * @ap: va list
 * @f: point to flags struct
 * Return: Number of printed char
 */
